...
function appendNewCard(parentElement) {
  ...
  */
  ...
  function flipCard() {
    // Your existing flipCard logic...

    // Check for a win condition after each card is flipped
    checkWin();
  }
  ...
  // Function to update the UI when the player wins
  function displayWinMessage() {
    // Get the game-container element
    var gameContainer = document.getElementById("game-container");

    // Create a new element for the win message
    var winMessage = document.createElement("div");
    winMessage.setAttribute("id", "win-message");
    winMessage.innerHTML = "<h2>Kamu Menang!</h2>";

    // Append the win message to the game container
